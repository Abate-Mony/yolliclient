...
const ContactUs = () => {
  ...
  const confirmFunc = () => {
    setOpen(false)
    router.push("/#testimonials")
    // window.location.href = 'https://www.google.com/maps/place/Saint+Paul+College/@40.4403269,-79.9903269,17z/data=!3m1!4b1!4m5!3m4!1s0
  ...
  return (
    <Layout className="container bg !pt-0 !mt-0 md:px-6 mx-auto">
      {/* <Loader toggle/> */}
      <AlertBox toggle={open} closeModal={closeModal} confirmFunc={confirmFunc}>
        Thanks for submitting your information will getback to you later
            ...
            <div class="flex flex-wrap">
              <div class="grow-0 shrink-0 basis-auto w-full xl:w-5/12 px-3 lg:px-6 mb-12 xl:mb-0">
                <form onSubmit={handleSubmit}>
                  ...
                  <div class="form-group mb-6">
                    <input required type="tel" class="form-control block
                      w-full
                      px-3
                      py-1.5
                      text-base
